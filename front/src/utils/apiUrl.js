...
const UPDATE_COMPLETED_TASKS_API_URL = 'http://localhost:8080/update_completed_task';
const UPDATE_TASK_API_URL = 'http://localhost:8080/update_task';

export { GET_TASKS_API_URL, POST_TASKS_API_URL, DELETE_TASKS_API_URL, UPDATE_COMPLETED_TASKS_API_URL, UPDATE_TASK_API_URL };
